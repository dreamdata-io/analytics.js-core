...
Analytics.prototype._parseQuery = function(query) {
  ...
  var group_traits = pickPrefix('ajs_group_', q);
  // Trigger based on callable parameters in the URL
  if (q.ajs_uid || q.ajs_trait_email) this.identify(q.ajs_uid, traits);
  if (q.ajs_gid || q.ajs_group_website) this.group(q.ajs_gid, group_traits);
